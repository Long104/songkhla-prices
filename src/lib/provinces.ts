/**
 * All 77 Thai provinces with official DOPA codes.
 * Songkhla = "90" (default province for the app).
 */
...
export const DEFAULT_PROVINCE_CODE = "90";

export const provincesSeed: ProvinceSeed[] = [
  ...
  { code: "19", nameTh: "สระแก้ว", nameEn: "Sa Kaeo" },
  ...
  { code: "27", nameTh: "สระบุรี", nameEn: "Saraburi" },
  ...
  { code: "39", nameTh: "นครพนม", nameEn: "Nakhon Phanom" },
  ...
  { code: "48", nameTh: "หนองบัวลำภู", nameEn: "Nong Bua Lam Phu" },
